...
export const matcherMap: Map<string | {}, TokenMatcher[]> = new Map([
    ...
    ['c', [keywordMatcher(tt.Case, 'case'), keywordMatcher(tt.Catch, 'catch'), keywordMatcher(tt.Class, 'class'), keywordMatcher(tt.Const, 'const'), keywordMatcher(tt.Continue, 'continue')]],
    ...
    ['e', [keywordMatcher(tt.Else, 'else'), keywordMatcher(tt.Extends, 'extends')]],
    ...
    ['s', [keywordMatcher(tt.Static, 'static'), keywordMatcher(tt.Super, 'super'), keywordMatcher(tt.Switch, 'switch')]],
